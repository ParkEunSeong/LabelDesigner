...
namespace SampleProgram
{
    ...
    enum SLCS_ERROR_CODE
    {
        ...
        ERR_CODE_LABEL_PAUSED = 10,	// Label paused in peeler unit
    ...
    partial class BXLLApi
    {
        ...
        public static bool PrintAztec(int nHorizontalPos, int nVerticalPos, int nBarcodeSize, int nExtendedChannel, int nEccSymbol, int nMenuSymbol, int nNumberOfSymbols, int nOptionalID, int nRotation, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintAztec(nHorizontalPos, nVerticalPos, nBarcodeSize, nExtendedChannel, nEccSymbol, nMenuSymbol, nNumberOfSymbols, nOptionalID, nRotation, pData);
            return BXLLApi_x86.PrintAztec(nHorizontalPos, nVerticalPos, nBarcodeSize, nExtendedChannel, nEccSymbol, nMenuSymbol, nNumberOfSymbols, nOptionalID, nRotation, pData);
        }

        public static bool PrintCode49(int nHorizontalPos, int nVerticalPos, int nNarrowBarWidth, int nWideBarWidth, int nBarHeight, int nHRI, int nStarting, int nRotation, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintCode49(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nHRI, nStarting, nRotation, pData);
            return BXLLApi_x86.PrintCode49(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nHRI, nStarting, nRotation, pData);
        }

        public static bool PrintCODABLOCK(int nHorizontalPos, int nVerticalPos, int nNarrowBarWidth, int nWideBarWidth, int nBarHeight, int nSecurity, int nDataColumns, string pMode, int nRowsEncode, int nRotation, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintCODABLOCK(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nSecurity, nDataColumns, pMode, nRowsEncode, nRotation, pData);
            return BXLLApi_x86.PrintCODABLOCK(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nSecurity, nDataColumns, pMode, nRowsEncode, nRotation, pData);
        }

        public static bool PrintMicroPDF(int nHorizontalPos, int nVerticalPos, int nModuleWidth, int nBarHeight, int nMode, int nRotation, int HRI, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintMicroPDF(nHorizontalPos, nVerticalPos, nModuleWidth, nBarHeight, nRotation, HRI, pData);
            return BXLLApi_x86.PrintMicroPDF(nHorizontalPos, nVerticalPos, nModuleWidth, nBarHeight, nRotation, HRI, pData);
        }

        public static bool PrintIMB(int nHorizontalPos, int nVerticalPos, int nRotation, int nHRI, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintIMB(nHorizontalPos, nVerticalPos, nRotation, nHRI, pData);
            return BXLLApi_x86.PrintIMB(nHorizontalPos, nVerticalPos, nRotation, nHRI, pData);
        }

        public static bool PrintMSIBarcode(int nHorizontalPos, int nVerticalPos, int nNarrowBarWidth, int nWideBarWidth, int nBarHeight, int nCheckdigit, int nCheckdigitHri, int nRotation, int nHRI, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintMSIBarcode(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nCheckdigit, nCheckdigitHri, nRotation, nHRI, pData);
            return BXLLApi_x86.PrintMSIBarcode(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nCheckdigit, nCheckdigitHri, nRotation, nHRI, pData);
        }

        public static bool PrintPlesseyBarcode(int nHorizontalPos, int nVerticalPos, int nNarrowBarWidth, int nWideBarWidth, int nBarHeight, int nCheckdigitHRI, int nRotation, int nHRI, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintPlesseyBarcode(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nCheckdigitHRI, nRotation, nHRI, pData);
            return BXLLApi_x86.PrintPlesseyBarcode(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nCheckdigitHRI, nRotation, nHRI, pData);
        }

        public static bool PrintTLC39Barcode(int nHorizontalPos, int nVerticalPos, int nNarrowBarWidth, int nWideBarWidth, int nBarHeight, int nPDF417Height, int nPDF417narrowbarWidth, int nRotation, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintTLC39Barcode(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nPDF417Height, nPDF417narrowbarWidth, nRotation, pData);
            return BXLLApi_x86.PrintTLC39Barcode(nHorizontalPos, nVerticalPos, nNarrowBarWidth, nWideBarWidth, nBarHeight, nPDF417Height, nPDF417narrowbarWidth, nRotation, pData);
        }

        public static bool PrintRSSBarcode(int nHorizontalPos, int nVerticalPos, int nRssType, int nMagnification, int nSeparatorHeight, int nBarcodeHeight, int nSegmentWidth, int nRotation, string pData)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintRSSBarcode(nHorizontalPos, nVerticalPos, nRssType, nMagnification, nSeparatorHeight, nBarcodeHeight, nSegmentWidth, nRotation, pData);
            return BXLLApi_x86.PrintRSSBarcode(nHorizontalPos, nVerticalPos, nRssType, nMagnification, nSeparatorHeight, nBarcodeHeight, nSegmentWidth, nRotation, pData);
        }
        ...
        public static bool PrintImageLZMA(int nHorizontalStartPos, int nVerticalStartPos, string pBitmapFilename, int nDither)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintImageLZMA(nHorizontalStartPos, nVerticalStartPos, pBitmapFilename, nDither);
            return BXLLApi_x86.PrintImageLZMA(nHorizontalStartPos, nVerticalStartPos, pBitmapFilename, nDither);
        }
        
        public static bool PrintImageLZMAW(int nHorizontalStartPos, int nVerticalStartPos, string pBitmapFilename, int nDither)
        {
            if (Is64Bit())
                return BXLLApi_x64.PrintImageLZMAW(nHorizontalStartPos, nVerticalStartPos, pBitmapFilename, nDither);
            return BXLLApi_x86.PrintImageLZMAW(nHorizontalStartPos, nVerticalStartPos, pBitmapFilename, nDither);
        }
        ...
        public static bool RFIDTransPosition(int transPosition)
        {
            if (Is64Bit())
                return BXLLApi_x64.RFIDTransPosition(transPosition);
            return BXLLApi_x86.RFIDTransPosition(transPosition);
        }
