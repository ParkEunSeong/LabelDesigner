    ...
    public partial class frmMain : Form
    {
        ...
        private void btnPrintSample_Click(object sender, EventArgs e)
        {
           ...
           // string DataMatrix_data = "BIXOLON Label Printer, This is for test.";
            ...
            var x = 135 * dotsPer1mm;
            var y = 5 * dotsPer1mm;
            BXLLApi.PrintTrueFont(x, y, fontName, 14, 0, true, true, false, "가나다", false);
            Debug.Print("Sample Label-1 x=" + x + ",y=" + y);

            //	Draw Lines
            x = 1 * dotsPer1mm;
            y = 10 * dotsPer1mm;
            int x1 = 71 * dotsPer1mm;
            int y1 = 11 * dotsPer1mm;
            BXLLApi.PrintBlock(x, y, x1, y1, (int)SLCS_BLOCK_OPTION.LINE_OVER_WRITING, 0);
            Debug.Print("line x=" + x + ",y=" + y + ",x1="+x1+",y1="+y1);
